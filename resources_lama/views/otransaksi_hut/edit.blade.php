...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Edit Pembayaran Hutang XXX{{$header->NO_BUKTI}}</h1>	
				</div>
				<div class="col-sm-6">
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
								...
								<div class="col-md-2 input-group" >
									<input type="text" onblur ='ambil_beliy()' class="form-control NO_PO" id="NO_PO" name="NO_PO" placeholder="Masukkan PO"value="{{$header->NO_PO}}" style="text-align: left" readonly >
