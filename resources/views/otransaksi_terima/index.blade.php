...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Transaksi Terima Gudang</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <table class="table table-fixed table-striped table-border table-hover nowrap datatable" id="datatable">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" style="text-align: left">BL</th>
                            <th scope="col" style="text-align: left">AJU</th>
                            <th scope="col" style="text-align: right">Kg</th>
                            <th scope="col" style="text-align: left">Cont</th>
